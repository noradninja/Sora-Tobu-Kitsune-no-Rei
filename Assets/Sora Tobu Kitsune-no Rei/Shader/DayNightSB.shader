	...
	LOD 0
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				#endif
				half3 worldSpaceLightDir = UnityWorldSpaceLightDir(WorldPosition);
				half dotResult81 = dot( -worldSpaceLightDir , float3( 0,1,0 ) );
				float NightTransScale235 = _NightTransitionScale;
				half4 lerpResult78 = lerp( _SkyColor , _NightColor , saturate( ( dotResult81 * NightTransScale235 ) ));
				float4 SkyColor197 = lerpResult78;
				float4 HorizonColor313 = _HorizonColor;
				half dotResult238 = dot( -worldSpaceLightDir , float3( 0,1,0 ) );
				float HorizonScaleDayNight304 = saturate( ( dotResult238 * ( NightTransScale235 + _NightTransitionHorizonDelay ) ) );
				half dotResult213 = dot( worldSpaceLightDir , float3( 0,1,0 ) );
				...
				half3 normalizeResult42 = normalize( WorldPosition );
				half dotResult40 = dot( normalizeResult42 , float3( 0,1,0 ) );
				float3 ase_worldViewDir = UnityWorldSpaceViewDir(WorldPosition);
				ase_worldViewDir = normalize(ase_worldViewDir);
				half dotResult12 = dot( -worldSpaceLightDir , ase_worldViewDir );
				float InvVDotL200 = dotResult12;
				half temp_output_22_0 = min( _HorizonSunGlowSpreadMin , _HorizonSunGlowSpreadMax );
				half temp_output_23_0 = max( _HorizonSunGlowSpreadMin , _HorizonSunGlowSpreadMax );
				half clampResult14 = clamp( (0.0 + (InvVDotL200 - ( 1.0 - ( temp_output_22_0 * temp_output_22_0 ) )) * (1.0 - 0.0) / (( 1.0 - ( temp_output_23_0 * temp_output_23_0 ) ) - ( 1.0 - ( temp_output_22_0 * temp_output_22_0 ) ))) , 0.0 , 1.0 );
				half dotResult88 = dot( worldSpaceLightDir , float3( 0,-1,0 ) );
				half clampResult89 = clamp( dotResult88 , 0.0 , 1.0 );
				...
				half4 lerpResult55 = lerp( SkyColor197 , HorizonColor313 , TotalHorizonMask314);
				half temp_output_2_0_g1 = TotalHorizonMask314;
				half temp_output_3_0_g1 = ( 1.0 - temp_output_2_0_g1 );
				half3 appendResult7_g1 = (half3(temp_output_3_0_g1 , temp_output_3_0_g1 , temp_output_3_0_g1));
				half3 temp_cast_1 = (_HorizonTintSunPower).xxx;
				float SunDiskSize286 = ( 1.0 - ( _SunDiskSize + _SunDiskSizeAdjust ) );
				half temp_output_262_0 = ( SunDiskSize286 * ( 1.0 - ( 0.99 + _SunDiskSharpness ) ) );
				half temp_output_75_0 = saturate( InvVDotL200 );
				half dotResult265 = dot( temp_output_75_0 , temp_output_75_0 );
				half smoothstepResult261 = smoothstep( ( SunDiskSize286 - temp_output_262_0 ) , ( SunDiskSize286 + temp_output_262_0 ) , dotResult265);
				half dotResult302 = dot( WorldPosition.y , 1.0 );
				...
				float4 Sky175 = ( lerpResult55 + half4( ( pow( ( ( HorizonColor313.rgb * temp_output_2_0_g1 ) + appendResult7_g1 ) , temp_cast_1 ) * SunDisk203 ) , 0.0 ) );
...
/*ASEBEGIN
Version=18707
43;118;1739;1086;2433.579;2592.619;1;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;20;-4219.824,33.2516;Float;False;Property;_HorizonSunGlowSpreadMin;Horizon Sun Glow Spread Min;8;0;Create;True;0;0;False;0;False;5.075109;0;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;21;-4229.824,122.2515;Float;False;Property;_HorizonSunGlowSpreadMax;Horizon Sun Glow Spread Max;9;0;Create;True;0;0;False;0;False;0;2.52;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;86;-1740.65,-1378.857;Float;False;Property;_NightTransitionScale;Night Transition Scale;11;0;Create;True;0;0;False;0;False;1;7.84;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;243;-4295.005,-2060.831;Float;False;Property;_NightTransitionHorizonDelay;Night Transition Horizon Delay;12;0;Create;True;0;0;False;0;False;0;-4.77;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;285;-4291.081,-1575.761;Float;False;Property;_SunDiskSizeAdjust;Sun Disk Size Adjust;4;0;Create;True;0;0;False;0;False;0;0.00299;0;0.01;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;252;-4285.656,-1807.189;Float;False;Property;_SunDiskSize;Sun Disk Size;3;0;Create;True;0;0;False;0;False;0;0;0;0.5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;29;-3553.177,244.8518;Float;False;Constant;_Float2;Float 2;3;0;Create;True;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;28;-3555.777,160.3517;Float;False;Constant;_Float1;Float 1;3;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;27;-3577.876,87.55197;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;216;-2229.349,-2180.238;Float;False;Constant;_HideHorizonGlowScale;Hide Horizon Glow Scale;12;0;Create;True;0;0;False;0;False;4.14;4.14;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;26;-3575.277,0.4519947;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.NormalizeNode;42;-4033.649,-463.454;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;281;-4015.29,-1428.623;Float;False;Property;_SunDiskSharpness;Sun Disk Sharpness;5;0;Create;True;0;0;False;0;False;0;0.0093;0;0.01;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;244;-1918.605,-2095.759;Float;False;Property;_HorizonMinAmountAlways;Horizon Min Amount Always;13;0;Create;True;0;0;False;0;False;0;0.238;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;16;-3063.753,77.28284;Float;False;Constant;_Float0;Float 0;0;0;Create;True;0;0;False;0;False;5;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;46;-3514.3,-367.9907;Float;False;Property;_HorizonSharpness;Horizon Sharpness;7;0;Create;True;0;0;False;0;False;5.7;12.64;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;17;-2870.218,66.3748;Float;False;Property;_HorizonGlowIntensity;Horizon Glow Intensity;6;0;Create;True;0;0;False;0;False;0.59;3.09;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;57;-1856.268,-889.3608;Float;False;Property;_HorizonColor;Horizon Color;1;0;Create;True;0;0;False;0;False;0.9137255,0.8509804,0.7215686,0;1,0.9080161,0.4274507,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;79;-725.8815,-1587.034;Float;False;Property;_NightColor;Night Color;2;0;Create;True;0;0;False;0;False;0,0,0,0;0.09251461,0.09571571,0.1981127,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LightColorNode;18;-2537.239,-1562.841;Inherit;False;0;3;COLOR;0;FLOAT3;1;FLOAT;2
Node;AmplifyShaderEditor.ColorNode;56;-735.8195,-1766.734;Float;False;Property;_SkyColor;Sky Color;0;0;Create;True;0;0;False;0;False;0.3764706,0.6039216,1,0;0.1200142,0.3730588,0.8207547,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;291;-1848.931,222.4503;Float;False;Property;_HorizonTintSunPower;Horizon Tint Sun Power;10;0;Create;True;0;0;False;0;False;0;3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;39;132.271,-911.8556;Half;False;True;-1;2;ASEMaterialInspector;0;1;DM/ProceduralSkybox;0770190933193b94aaa3065e307002fa;True;Unlit;0;0;Unlit;2;True;0;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;True;0;False;-1;0;False;-1;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;True;True;True;True;True;0;False;-1;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;RenderType=Opaque=RenderType;True;2;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=ForwardBase;False;0;;0;0;Standard;1;Vertex Position,InvertActionOnDeselection;1;0;1;True;False;;False;0
...
ASEEND*/
//CHKSM=72A5D449D75F87CAE3B52942A72A54A390C874B7