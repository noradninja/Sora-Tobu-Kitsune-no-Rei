Shader "NPR Contour Drawing/Contour Drawing Transparent" {
    Properties {
		...
		_ContourTexture("Contour Texture", 2D) = "white"{}
	 ...
	 SubShader {
	   Tags {
		...
		Pass {
			...
			uniform sampler2D _ContourTexture;
			fixed4 _ContourTexture_ST;
			UNITY_INSTANCING_BUFFER_START(Props)
