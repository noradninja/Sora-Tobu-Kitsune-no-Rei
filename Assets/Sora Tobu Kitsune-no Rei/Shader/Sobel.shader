Shader "Unlit/Sobel"
{
	Properties
	{
		...
		_OutlineDensity("Density", Float) = 0.0 
		_OutlineThickness("Thickness", Float) = 0.0
		_OutlineColor("Color", Color) = (0,0,0,1)
		_OutlineDepthBias("Depth Bias", Float) = 0.0
		_OutlineNormalBias("Normal Bias", Float) = 0.0
		_OutlineNormalMultiplier("Normal Multiplier", Float) = 0.0
	}
	SubShader
	{
